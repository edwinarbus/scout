...
/**
 * Ensure the curator agent + a cloud environment exist, creating them once and
 * caching their ids in data/managed-agent.json. A changed model or prompt
 * version provisions a fresh agent. Returns the ids to run a session with.
 */
